...
@Component({
  selector: 'app-pianifica-colloquio',
  templateUrl: './pianifica-colloquio.component.html',
  styleUrls: ['./pianifica-colloquio.component.scss']
})

export class PianificaColloquioComponent implements OnInit {
